...
const DOBPicker = ({ dob_d, dob_m, dob_y, onChange }: {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* RESPONSIVE: calendar popover constrained to viewport on small screens */}
      <div className="relative" ref={ref}>
        <div className="flex gap-1.5 items-center">
          <input placeholder="DD" value={dob_d} maxLength={2}
            onChange={e => onChange("dob_d", e.target.value.replace(/\D/g, "").slice(0, 2))}
        ...
        {open && (
          /* RESPONSIVE: full-width on small screens, fixed 288px on larger */
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-sky-50"
      ...
      <nav className="sticky top-0 z-30 h-14 sm:h-16 bg-white/95 backdrop-blur-md border-b-2 border-blue-100 shadow-sm shadow-blue-50">
        <div className="max-w-2xl mx-auto px-3 sm:px-6 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* RESPONSIVE: slightly smaller title on mobile */}
      ...
      <main className="max-w-2xl mx-auto px-3 sm:px-4 py-6 sm:py-10 pb-16 sm:pb-20">
        ...
        {/* ── Header ── */}
        {/* RESPONSIVE: tighter header on mobile */}
